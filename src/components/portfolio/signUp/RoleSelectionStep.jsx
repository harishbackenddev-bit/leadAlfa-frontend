      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        {roles.map((role) => {
          ...
          return (
            ...
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-gradient-to-b from-[#0353a4] to-[#4b96e3]">
              ...
              <button
                ...
                className="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-b from-[#0353a4] to-[#4b96e3] px-5 py-3.5 text-sm font-medium text-white transition hover:bg-blue-700 disabled:pointer-events-none disabled:opacity-60 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-offset-2"
              >
                <span>
                  {loading
                    ? "Please wait..."
