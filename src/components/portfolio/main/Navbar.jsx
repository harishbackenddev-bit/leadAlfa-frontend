...
export default function Navbar() {
  ...
  const profilePhotoUrl = user?.profile?.media?.profilePhoto?.mediaDetails?.url || "";
            ...
            {!isLoggedIn ? (
              <>
                <SelectDropdown
                  ...
                  liClassName="p-0!"
                  items={[
                    <Link to="/login" className="flex  gap-2 px-5 py-3">
                      <BrandIcon />
                      <div>
                    ...
                    <Link to="/login" className="flex gap-2 px-5 py-3"><CreatorIcon />
                      <div>
                        <h5 className="font-bold">I'm a creator</h5>
                        <p className="text-[12px]">Monetize your content</p>
                      </div>
                    </Link>,
                  ]}
                  trigger="hover"
              ...
              <>
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-teal-400 to-teal-600 overflow-hidden flex items-center justify-center text-white font-semibold text-sm">
                    {profilePhotoUrl ? (
                  ...
                  <div className="leading-tight">
                    ...
                    <div className="text-xs text-white capitalize">{user?.role || "User"}</div>
                  </div>
                </Link>
              ...
              <div className="border-b border-gray-100">
                ...
                {mobileServicesOpen && (
                  <div className="bg-[#F7F8F9] px-4 py-3 space-y-4">
                    <div>
                      <p className="px-2 text-xs font-semibold uppercase tracking-wide text-[#6A6A70] mb-2">
                        Solutions
                      </p>
