    ...
    <div className={`min-h-screen bg-gray-50 ${isBrand ? "p-4 md:p-6" : "p-6"}`}>
      <div className="mx-auto max-w-[1920px]">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="font-anton text-2xl text-gray-900">Notifications</h1>
        ...
        {notifications.length > 0 ? (
          <div className="mt-4 grid grid-cols-3 gap-2 sm:gap-3">
            <div className="rounded-xl border border-gray-100 bg-white p-3 shadow-sm sm:p-4">
              ...
              <p className="font-anton text-2xl text-gray-900 sm:text-3xl">
                {totalCount}
              </p>
            </div>
            <div className="rounded-xl border border-gray-100 bg-white p-3 shadow-sm sm:p-4">
              <p className="text-[11px] text-gray-500 sm:text-xs">Unread</p>
              <p className="font-anton text-2xl text-[#1E60DB] sm:text-3xl">
                {unreadCount}
              </p>
            </div>
            <div className="rounded-xl border border-gray-100 bg-white p-3 shadow-sm sm:p-4">
              <p className="text-[11px] text-gray-500 sm:text-xs">Read</p>
              <p className="font-anton text-2xl text-green-600 sm:text-3xl">
                {readCount}
              </p>
            </div>
          </div>
