...
import { getCampaignCreatorVisibleBudget } from "../../../components/campaign/campaignViewUtils";
...
function formatPayment(campaign) {
  const visible = formatCurrency(getCampaignCreatorVisibleBudget(campaign));
