...
export default function Messages() {
  ...
  return (
    <div className="h-[calc(100dvh-80px)] overflow-hidden bg-white 2xl:h-[calc(100dvh-88px)]">
      <div className="h-full w-full">
        <div className="relative flex h-full overflow-hidden border-t border-gray-200 bg-white">
          {/* Sidebar - Slides in/out on xs/sm/md, always visible on lg+ */}
          <div
            className={`h-full w-full shrink-0 border-r border-gray-200 transition-transform duration-300 ease-in-out lg:w-[380px] lg:translate-x-0 ${
              showChat
          ...
          <div
            className={`absolute inset-0 h-full flex-1 transition-transform duration-300 ease-in-out lg:relative lg:inset-auto ${
