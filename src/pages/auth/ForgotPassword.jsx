...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await forgotPassword(captcha.withCaptchaPayload({ email }));
      setSuccess(true);
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center py-12 gap-4 bg-[#faf9f6]">
      ...
      <div className="w-[90%] md:w-[60vw] 2xl:w-[65vw] bg-white/95 rounded-2xl p-8 shadow overflow-visible">
        <div className="max-w-md mx-auto flex flex-col gap-6 min-w-0">
          <div className="text-center">
          ...
          {!success && (
            <form className="flex min-w-0 flex-col gap-3" onSubmit={handleSubmit}>
              ...
              <TurnstileField captcha={captcha} className="mt-1" />
