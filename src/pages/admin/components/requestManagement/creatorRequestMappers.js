...
const buildIdentityDocuments = (raw) => {
  ...
  const profilePhoto = mapMediaAsset(media.profilePhoto, "Profile Photo", "image");
...
const buildLocationDetails = (raw) => {
  const hasSaLocation = Boolean(
    get(raw, ["province", "city", "streetNumber", "addressLine1"], "")
  );
  ...
  return [
    ...
    { label: "Suburb", value: get(raw, ["suburb", "location.suburb"], "—") },
    {
      label: "Address Line 1",
      value: get(raw, ["addressLine1", "streetNumber", "location.addressLine1"], "—"),
    },
    { label: "Address Line 2", value: get(raw, ["addressLine2", "location.addressLine2"], "—") },
    { label: "Postal Code", value: get(raw, ["postalZipCode", "postalCode", "zipCode"], "—") },
    {
      label: "Delivery Instructions",
      value: get(raw, ["deliveryInstructions", "location.deliveryInstructions"], "—"),
    },
