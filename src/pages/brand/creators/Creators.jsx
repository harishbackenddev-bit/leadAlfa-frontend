    ...
    <div className="min-h-screen bg-[#f4f6f9]">
      <div className="mx-auto max-w-[19200px] px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h1 className="text-[26px] font-bold text-[#1a1a1a] sm:text-[30px]">
              View Creators
            </h1>
          ...
          <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center lg:w-auto lg:min-w-[520px]">
            <div className="flex flex-1 gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-[#e5e7eb] bg-white pl-10 pr-4 text-[14px] text-[#1e293b] outline-none transition focus:border-[#1E60DB] focus:ring-2 focus:ring-[#1E60DB]/20"
                />
              </div>
              ...
              <button
                ...
                className={`flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-lg border bg-white transition ml-auto ${filtersOpen || hasActiveFilters
            ...
            <Button
              ...
              className="h-11 flex-shrink-0 rounded-lg btn-gradient px-6 text-[14px] font-semibold sm:px-8"
            >
              See Invites
            </Button>
          </div>
