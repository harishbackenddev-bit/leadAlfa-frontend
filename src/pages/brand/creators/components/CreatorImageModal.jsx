...
export default function CreatorImageModal({ open, imageUrl, title, onClose }) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-label={title ? `${title} image` : "Submission image"}
      onClick={onClose}
    >
      <div
        className="relative flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-black shadow-2xl"
