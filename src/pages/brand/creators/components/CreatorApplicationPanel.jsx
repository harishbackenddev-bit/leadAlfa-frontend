  ...
  return (
    <section className="rounded-2xl border border-[#e8edf3] bg-white p-5 shadow-sm sm:p-6">
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="font-['Manrope:SemiBold',sans-serif] text-[18px] font-semibold text-[#1a1a1a]">
            Pending Application
          </h2>
      ...
      <div className="mb-4">
        <h3 className="mb-2 font-anton text-base font-semibold text-gray-900">
          Proposal
        </h3>
      ...
      {application?.proposedBudget ? (
        <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-emerald-50 px-3 py-1 text-sm font-semibold text-emerald-700">
          Proposed budget: R {application.proposedBudget}
        </div>
      ) : null}
