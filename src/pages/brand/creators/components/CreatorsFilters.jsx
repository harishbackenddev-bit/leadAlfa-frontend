...
const inputClassName =
  "h-11 w-full rounded-lg border border-[#e5e7eb] bg-white px-3 text-[14px] text-[#1e293b] outline-none transition focus:border-[#1E60DB] focus:ring-2 focus:ring-[#1E60DB]/20 disabled:cursor-not-allowed disabled:border-[#e2e8f0] disabled:bg-[#f8fafc] disabled:text-[#94a3b8]";

const labelClassName =
  "mb-2 block text-[13px] font-medium text-[#64748b]";
    ...
    <section className="mb-6 rounded-2xl border border-[#e8edf3] bg-white p-5 shadow-sm sm:p-6">
      ...
      <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
        <Button
          ...
          variant="outline"
          onClick={onClear}
          className="h-11 rounded-lg border-[#e5e7eb] px-6 text-[14px] text-[#475569] hover:bg-[#f8fafc]"
        >
          Clear All
        </Button>
        <Button
          type="button"
          onClick={onApply}
          className="h-11 rounded-lg btn-gradient px-8 text-[14px] font-semibold"
        >
          Apply Filters
        </Button>
      </div>
