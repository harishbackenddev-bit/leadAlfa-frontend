  ...
  return (
    <div className="space-y-4">
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-red-100 bg-red-50 px-4 py-12 text-center text-sm text-red-600">
          {error?.message || "Failed to load approved assets. Please try again."}
        </div>
      ) : assets.length === 0 ? (
        <div className="rounded-xl border border-gray-200 bg-white px-4 py-12 text-center text-sm text-gray-500">
          {emptyMessage}
