...
function ProposalSidebar({
  ...
  const budget = formatProposalAmount(proposal.proposedBudget);
  ...
  return (
    <div className="rounded-lg bg-gray-50 p-4 lg:min-w-[220px]">
      ...
      <p className="mt-1 text-2xl font-bold text-gray-900">{budget}</p>
      <p className="text-xs text-gray-500">per campaign deliverable set</p>
  ...
  return (
    ...
    >
      <ProposalCardHeader
        ...
        formatAmount={formatProposalAmount}
      />
